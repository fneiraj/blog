...
title: Adding functionality to interfaces in Spring Boot
slug: adding-functionality-to-interfaces-in-spring-boot
featured: true
draft: false
tags:
  - springboot
  ...
  - java
  - proxy
description: How to add functionality to interfaces in Spring Boot using Cglib
---
