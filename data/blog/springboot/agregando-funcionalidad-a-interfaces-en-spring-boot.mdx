...
```java:ResourceProviderBeanDefinitionRegistryPostProcessor.java
...
ahora modificamos la clase `ResourceProviderBeanDefinitionRegistryPostProcessor.java` para indicar cual clase es nuestra factory:
